    ...
    <SubpageLayout>
        ...
        <div className="site-container">
          <div className="reveal" style={{ maxWidth: "800px", margin: "0 auto", textAlign: "center" }}>
            ...
            <p style={{
              ...
              Survey No. 357, Fort, Belagavi &mdash; the blessed house of Sri Haripada Mitra where Swamiji stayed for 9 days in October 1892.
            </p>
      ...
      <section style={{ padding: "60px 0 70px" }}>
        <div className="site-container">
          ...
          {/* Haripada Mitra House — featured image+caption */}
          <div className="reveal" style={{ maxWidth: "850px", margin: "50px auto 0", overflow: "hidden", boxShadow: "0 12px 40px rgba(26,47,47,0.12)", border: "1px solid #E8E2D8" }}>
      ...
      {/* Key Milestones — full-bleed teal band */}
      ...
      <section style={{ padding: "80px 0", background: "#F3EDE4" }}>
        <div className="site-container">
          ...
          {/* Temple Image — featured */}
          <div className="reveal" style={{ maxWidth: "1000px", margin: "0 auto 50px", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "30px", alignItems: "center" }}>
            <div style={{ overflow: "hidden", border: "1px solid #E8E2D8", boxShadow: "0 12px 40px rgba(26,47,47,0.12)" }}>
              <Image src="/images/Cropped-SVM-_E7A9941-1.jpg" alt="Universal Temple of Sri Ramakrishna" width={500} height={380} style={{ width: "100%", height: "auto", display: "block" }} sizes="500px" />
            </div>
            <div>
              <p style={{ fontSize: "11px", fontWeight: 700, letterSpacing: "3px", textTransform: "uppercase", color: "#B8860B", marginBottom: "12px" }}>
                Consecrated January 2004
              </p>
              ...
              <p style={{ fontSize: "15px", color: "#5A5650", lineHeight: 1.85 }}>
                The grand Universal Temple of Bhagavan Sri Ramakrishna stands next to
                the Sadhu Nivas, a landmark in the history of the Ashrama and the city.
              </p>
            </div>
          </div>
          ...
          <div className="reveal" style={{ maxWidth: "780px", margin: "0 auto" }}>
            ...
            {/* Temple Timings — Memorial-style info card */}
            <div style={{
              background: "#fff",
              ...
              <div style={{ padding: "28px 32px" }}>
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px 40px", fontSize: "15px", color: "#4A4743", marginBottom: "24px" }}>
                  <div>
                    ...
                    <p>5:30 am to 12 noon</p>
                    <p>4:00 pm to 8:30 pm</p>
                  </div>
                  <div>
                    <p style={{ fontSize: "11px", fontWeight: 600, letterSpacing: "1.5px", textTransform: "uppercase", color: "#B8860B", marginBottom: "4px" }}>Daily Schedule</p>
                  </div>
                </div>
                <div style={{ borderTop: "1px solid #E8E2D8", paddingTop: "20px", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "14px 40px" }}>
                  {[
                    ...
                    <div key={item.event} style={{ display: "flex", gap: "12px", alignItems: "baseline" }}>
                      <span style={{ fontSize: "12px", fontWeight: 600, color: "#B8860B", whiteSpace: "nowrap", minWidth: "104px" }}>{item.time}</span>
      ...
      <section style={{ padding: "80px 0" }}>
        <div className="site-container">
          <div className="reveal">
            <SectionHeading title="Swami Vivekananda Monument" />
          </div>
          <div className="reveal" style={{ maxWidth: "780px", margin: "0 auto" }}>
            <p style={{ fontSize: "16px", color: "#4A4743", lineHeight: 1.9, textAlign: "justify", marginBottom: "18px" }}>
      ...
      <section style={{ padding: "70px 0", background: "#F3EDE4" }}>
        <div className="site-container">
          <div className="reveal">
            <SectionHeading title="Book Store" />
          </div>
          <div className="reveal" style={{ maxWidth: "780px", margin: "0 auto" }}>
            <p style={{ fontSize: "16px", color: "#4A4743", lineHeight: 1.9, textAlign: "justify" }}>
      ...
      <section style={{ padding: "80px 0" }}>
        <div className="site-container">
          <div className="reveal">
            <SectionHeading title="Arise! Awake! &mdash; An Exhibition" />
          </div>
          <div className="reveal" style={{ maxWidth: "780px", margin: "0 auto" }}>
            <p style={{ fontSize: "16px", color: "#4A4743", lineHeight: 1.9, textAlign: "justify" }}>
      ...
      <section style={{ padding: "70px 0", background: "#F3EDE4" }}>
        <div className="site-container">
          <div className="reveal">
            <SectionHeading title="Sabhangana" />
          </div>
          <div className="reveal" style={{ maxWidth: "780px", margin: "0 auto" }}>
            <p style={{ fontSize: "16px", color: "#4A4743", lineHeight: 1.9, textAlign: "justify" }}>
        ...
        <div style={{ position: "relative", width: "100%", maxHeight: "360px", overflow: "hidden" }}>
          ...
          <div style={{
            ...
            <div style={{ textAlign: "center", maxWidth: "780px", padding: "0 24px" }}>
              <div style={{ width: "1px", height: "40px", background: "#B8860B", margin: "0 auto 28px", opacity: 0.7 }} />
              <p style={{
                fontFamily: '"Cormorant Garamond", Georgia, serif',
              ...
              <div style={{ width: "1px", height: "40px", background: "#B8860B", margin: "28px auto 0", opacity: 0.7 }} />
            </div>
          </div>
        </div>
      </section>
